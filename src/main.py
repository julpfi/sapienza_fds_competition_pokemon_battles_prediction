...
if __name__ == "__main__":
    ...
    battles_test, turns_test, teams_test = clean.clean_data(raw_data=raw_test_data, train=True)
    X_test = feature_engineering.feature_engineering(battles=battles_train, turns=turns_train, teams=teams_train, version=version, train=True)
