...
# HELPER 1: K.O. and HP % (Modified from version 5)
...
def _create_timeline_features(turns_df: pd.DataFrame) -> pd.DataFrame:
    ...
    # --- ADDED THESE TWO LINES respect to version6 ---
    ...
    # FillNa: 0.5 for AVG (neutral), 0.0 for SUM (no HP resource)
    ...
    # Per your request: We are NOT dropping p1_team_avg_hp or p2_team_avg_hp
    
    return timeline_features_df



# 2: STATUS PRESSURE (Refined v4)
...
# 3: DYNAMIC MATCHUP (Kept from v3)
